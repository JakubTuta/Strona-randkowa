...
<template>
  <v-navigation-drawer v-model="drawer" temporary location="right" class="pt-2">
    <div class="hidden-sm-and-up">
      <v-list-item append-icon="mdi-account" :title="$t('navBar.user.myProfile')" />
...
<!--    <v-list-item link :title="$t('navBar.user.communities')" append-icon="mdi-account-group" />-->
    ...
    <v-list-item to="/user/meet" link :title="$t('navBar.user.meet')" append-icon="mdi-heart" />
    <v-list-item to="/user/chat" link :title="$t('navBar.user.chat')" append-icon="mdi-chat" />
